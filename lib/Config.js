...
function loadDefaultGuthrieSettings() {
  ...
  this.guthrie.defaultDirectories = this.guthrie.defaultDirectories || guthrieSettings.defaultDirectories;
  this.guthrie.viewsExt = this.guthrie.viewsExt || guthrieSettings.viewsExt;
  this.guthrie.controllerNameAffix = this.guthrie.controllerNameAffix || guthrieSettings.controllerNameAffix;
  this.guthrie.defaultAction = this.guthrie.defaultAction || guthrieSettings.defaultAction;
}
